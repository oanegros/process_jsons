...
for path in dfs:
    ...
    g = sns.scatterplot(data=df, x='time', y='value',  hue="variable", lw=1, palette="colorblind", ax=ax, s=0.5, alpha=0.1) 
    ...
    plt.savefig(keywords.nfile("evolvables/scatter"+ path[-4:] +".png"), dpi=600)
    plt.close()
